...
export const BENCHMARK_SAMPLES: BenchmarkSample[] = [
  ...
  { id: "video-two-person-interaction", blindSampleId: "VID-03", kind: "video", category: "two-person interaction", prompt: "Two fictional adult workshop partners pass a small box across a clean table, clear handoff, stable camera, friendly neutral mood", negativePrompt: NEGATIVE, seed: 5107, width: 854, height: 480, frames: 49, fps: 24, steps: 20, inputAsset: SYNTHETIC_ASSET },
  { id: "video-pan", blindSampleId: "VID-04", kind: "video", category: "camera pan", prompt: "Slow horizontal camera pan across a quiet model village at golden hour, smooth motion, no sudden cuts", negativePrompt: NEGATIVE, seed: 5103, width: 854, height: 480, frames: 49, fps: 24, steps: 20, inputAsset: SYNTHETIC_ASSET },
  { id: "video-dolly", blindSampleId: "VID-05", kind: "video", category: "dolly in or out", prompt: "A gentle camera push toward a ceramic still life on a wooden table, shallow depth of field, stable geometry", negativePrompt: NEGATIVE, seed: 5104, width: 854, height: 480, frames: 49, fps: 24, steps: 20, inputAsset: SYNTHETIC_ASSET },
  { id: "video-object-motion", blindSampleId: "VID-06", kind: "video", category: "object motion", prompt: "A small toy train moves slowly along a tabletop track while the background stays still, clear object motion, fixed camera", negativePrompt: NEGATIVE, seed: 5108, width: 854, height: 480, frames: 49, fps: 24, steps: 20, inputAsset: SYNTHETIC_ASSET },
  { id: "video-i2v-single-frame", blindSampleId: "VID-07", kind: "video", category: "single first-frame I2V", prompt: "The synthetic scene gains a soft breeze and subtle parallax, preserve the first frame composition", negativePrompt: NEGATIVE, seed: 5105, width: 854, height: 480, frames: 49, fps: 24, steps: 20, inputAsset: SYNTHETIC_ASSET },
  { id: "video-flf2v-transition", blindSampleId: "VID-08", kind: "video", category: "first-last-frame transition candidate", prompt: "A calm transition from the first composition to a matching final composition, preserve object identity and smooth camera motion", negativePrompt: NEGATIVE, seed: 5106, width: 854, height: 480, frames: 49, fps: 24, steps: 20, inputAsset: SYNTHETIC_ASSET },
];
