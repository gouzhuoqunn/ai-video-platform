...
## Stage 3A.1 audible dependency note

Audible presets must not infer an unverified full-checkpoint plus LoRA combination. The 4090 preset records only a blocked compatibility requirement; the 5090 quality path and the 1080p upscaler path remain blocked until immutable evidence closes their exact dependency layouts.
