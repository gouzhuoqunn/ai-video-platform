...
upsertGenerationTasks([createGenerationTask({ id: "immediate-image", generationType: "image", prompt: "restart", modelProfile: "flux2-klein-4b", priority: "immediate", status: "armed" })], statePath);
...
const observed = applyMarketObservation([{ serverId: "host-1", gpu: "RTX 4090", vramGb: 24, reliability: 0.999, rating: 5, projectedCostUsd: 1.2, hourlyUsd: 0.3 }], statePath, Date.parse("2026-07-16T00:00:00.000Z"));
