...
const flux = registry.models.find((model) => model.modelProfile === "flux2-klein-4b");
assert.ok(flux);
const blocked = { schemaVersion: 1 as const, models: [{ ...flux, cached: false, restoreReady: false, validatedFallback: false }] };
