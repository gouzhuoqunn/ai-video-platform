...
assert.deepEqual({ width: video.outputMetadata.width, height: video.outputMetadata.height, frames: video.outputMetadata.frames, fps: video.outputMetadata.fps, seed: video.outputMetadata.seed }, { width: 832, height: 480, frames: 33, fps: 16, seed: 20260715 });
assert.deepEqual(generationPoolSummary(second.state).acceptableGpuClasses, ["rtx4090", "rtx5090"]);
